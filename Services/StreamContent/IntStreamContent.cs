...
namespace Slagkraft.Services
{
    ...
    /// </summary>
    public class IntStreamContent : IActionResult
    {
        ...
        public IntStreamContent(Action<Stream, CancellationToken, int> onStreamAvailable, string contentType, int required)
        {
