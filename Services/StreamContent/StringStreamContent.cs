...
namespace Slagkraft.Services
{
    ...
    /// </summary>
    public class StringStreamContent : IActionResult
    {
        #region Private Fields

        private readonly string _contentType;
        private readonly Action<Stream, CancellationToken, string> _onStreamAvailable;
        ...
        /// <param name="required">The string you need for the Stream method</param>
        public StringStreamContent(Action<Stream, CancellationToken, string> onStreamAvailable, string contentType, string required)
        {
